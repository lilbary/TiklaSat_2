package com.gib.tiklasat.admin;

import com.gib.tiklasat.auction.AuctionDto;
import com.gib.tiklasat.auth.SecurityConfig;

import com.gib.tiklasat.admin.AdminDashboardStatsDto;
import com.gib.tiklasat.user.UserDto;
import com.gib.tiklasat.auction.Auction;
import com.gib.tiklasat.user.Role;
import com.gib.tiklasat.admin.AdminService;
import com.gib.tiklasat.user.UserService;
...
public class AdminController {
    ...
    public ResponseEntity<List<com.gib.tiklasat.auction.AuctionDto>> getPendingAuctions() {
        List<com.gib.tiklasat.auction.AuctionDto> dtos = adminService.getPendingAuctions().stream()
            .map(auction -> com.gib.tiklasat.auction.AuctionDto.fromEntity(auction, auction.getStartingPrice()))
            .toList();
